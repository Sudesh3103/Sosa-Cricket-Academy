...
const CTASection = ({
  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] bg-[#08130e]">
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,11,8,0.94)_0%,rgba(5,11,8,0.72)_35%,rgba(5,11,8,0.72)_65%,rgba(5,11,8,0.94)_100%)]" />
