const AboutCTA = ({ cta }) => {
  return (
    <section className="mx-auto max-w-7xl px-6 pb-24">
      <div className="rounded-4xl border border-white/10 bg-[radial-gradient(circle_at_top,rgba(255,193,7,0.18),transparent_20%),linear-gradient(180deg,#081411_0%,#0f2318_100%)] p-10 text-center shadow-[0_30px_80px_rgba(0,0,0,0.16)]">
